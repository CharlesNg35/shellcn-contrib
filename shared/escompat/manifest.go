...
func actions(provider Provider) []plugin.Action {
	return []plugin.Action{
		...
		{ID: routeID(provider, "index.delete"), Label: "Delete", Icon: icon("trash-2"), RouteID: routeID(provider, "index.delete"), Params: indexParams(), Confirm: true, ConfirmText: "Delete this index and all documents?", Bulk: true},
		...
		{ID: routeID(provider, "document.delete"), Label: "Delete", Icon: icon("trash"), RouteID: routeID(provider, "document.delete"), Params: documentParams(), Confirm: true, ConfirmText: "Delete this document?", Bulk: true},
		...
		{ID: routeID(provider, "alias.delete"), Label: "Remove", Icon: icon("trash"), RouteID: routeID(provider, "alias.delete"), Params: aliasParams(), Confirm: true, ConfirmText: "Remove this alias?", Bulk: true},
	}
}
