...
func actions() []plugin.Action {
	return []plugin.Action{
		...
		{ID: "clickhouse.column.drop", Label: "Drop column", Icon: icon("trash"), RouteID: "clickhouse.column.drop", Params: map[string]string{"database": "${record.database}", "table": "${record.table}", "name": "${record.name}"}, Confirm: true, ConfirmText: "Drop this column? Its data is permanently removed.", OnSuccess: &plugin.ActionSuccess{SelectTab: "columns"}},
		...
		{ID: "clickhouse.index.drop", Label: "Drop index", Icon: icon("trash"), RouteID: "clickhouse.index.drop", Params: map[string]string{"database": "${record.database}", "table": "${record.table}", "name": "${record.name}"}, Confirm: true, ConfirmText: "Drop this data-skipping index?", OnSuccess: &plugin.ActionSuccess{SelectTab: "indexes"}},
		...
		{ID: "clickhouse.constraint.drop", Label: "Drop constraint", Icon: icon("trash"), RouteID: "clickhouse.constraint.drop", Params: map[string]string{"database": "${record.database}", "table": "${record.table}", "name": "${record.name}"}, Confirm: true, ConfirmText: "Drop this constraint?", OnSuccess: &plugin.ActionSuccess{SelectTab: "constraints"}},
