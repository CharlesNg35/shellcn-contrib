...
func tree() []plugin.TreeGroup {
	return []plugin.TreeGroup{
		{Key: "overview", Label: "Overview", Icon: icon("layout-dashboard"), Ref: &plugin.ResourceIdentity{Kind: "server", Name: "Loki", UID: "server"}},
...
func actions() []plugin.Action {
	return []plugin.Action{
		...
		{ID: rid("delete.cancel"), Label: "Cancel", Icon: icon("circle-x"), RouteID: rid("delete.cancel"), Params: map[string]string{"request": "${record.request_id}"}, Confirm: true, ConfirmText: "Cancel this Loki delete request?", Bulk: true},
	}
}
