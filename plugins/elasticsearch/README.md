# ShellCN Elasticsearch plugin

External ShellCN plugin for Elasticsearch.
...
```sh
CGO_ENABLED=0 go build -trimpath -ldflags "-s -w" -o shellcn-plugin-elasticsearch ./cmd/shellcn-plugin-elasticsearch
```
