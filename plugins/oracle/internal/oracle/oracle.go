...
func actions() []plugin.Action {
	return []plugin.Action{
		...
		{ID: "oracle.schema.drop", Label: "Drop schema", Icon: icon("trash-2"), RouteID: "oracle.schema.drop", Params: map[string]string{"schema": "${resource.name}"}, Confirm: true, ConfirmText: "Drop this schema (user)? The user and every object it owns are permanently deleted.", OnSuccess: &plugin.ActionSuccess{SelectTab: "schemas"}, Bulk: true},
		...
		{ID: "oracle.column.drop", Label: "Drop column", Icon: icon("trash"), RouteID: "oracle.column.drop", Params: map[string]string{"id": "${record.id}", "name": "${record.name}"}, Confirm: true, ConfirmText: "Drop this column? Its data is permanently removed.", OnSuccess: &plugin.ActionSuccess{SelectTab: "columns"}, Bulk: true},
		...
		{ID: "oracle.index.drop", Label: "Drop index", Icon: icon("trash"), RouteID: "oracle.index.drop", Params: map[string]string{"id": "${record.id}", "name": "${record.name}"}, Confirm: true, ConfirmText: "Drop this index?", OnSuccess: &plugin.ActionSuccess{SelectTab: "indexes"}, Bulk: true},
		...
		{ID: "oracle.constraint.drop", Label: "Drop constraint", Icon: icon("trash"), RouteID: "oracle.constraint.drop", Params: map[string]string{"id": "${record.id}", "name": "${record.name}"}, Confirm: true, ConfirmText: "Drop this constraint?", OnSuccess: &plugin.ActionSuccess{SelectTab: "constraints"}, Bulk: true},
		{ID: "oracle.table.truncate", Label: "Truncate", Icon: icon("trash"), RouteID: "oracle.table.truncate", Params: objectParams(), Confirm: true, ConfirmText: "Truncate this table? Every row will be deleted.", Bulk: true},
		{ID: "oracle.table.drop", Label: "Drop", Icon: icon("trash-2"), RouteID: "oracle.table.drop", Params: objectParams(), Confirm: true, ConfirmText: "Drop this table? The table definition and data will be permanently deleted.", Bulk: true},
		{ID: "oracle.view.drop", Label: "Drop", Icon: icon("trash-2"), RouteID: "oracle.view.drop", Params: objectParams(), Confirm: true, ConfirmText: "Drop this view?", Bulk: true},
		{ID: "oracle.session.kill", Label: "Kill session", Icon: icon("circle-x"), RouteID: "oracle.session.kill", Params: map[string]string{"id": "${resource.uid}"}, Confirm: true, ConfirmText: "Kill this session? In-flight work is rolled back and the connection is terminated immediately.", Bulk: true},
		...
		{ID: "oracle.user.drop", Label: "Drop user", Icon: icon("trash-2"), RouteID: "oracle.user.drop", Params: map[string]string{"user": "${resource.name}"}, Confirm: true, ConfirmText: "Drop this user? The user and every object it owns are permanently deleted.", Bulk: true},
	}
}
