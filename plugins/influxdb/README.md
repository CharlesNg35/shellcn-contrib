# ShellCN Influxdb plugin

External ShellCN plugin for Influxdb.
...
```sh
CGO_ENABLED=0 go build -trimpath -ldflags "-s -w" -o shellcn-plugin-influxdb ./cmd/shellcn-plugin-influxdb
```
