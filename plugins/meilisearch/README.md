# ShellCN Meilisearch plugin

External ShellCN plugin for Meilisearch.
...
```sh
CGO_ENABLED=0 go build -trimpath -ldflags "-s -w" -o shellcn-plugin-meilisearch ./cmd/shellcn-plugin-meilisearch
```
