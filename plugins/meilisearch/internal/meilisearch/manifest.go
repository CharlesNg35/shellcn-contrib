...
func actions() []plugin.Action {
	return []plugin.Action{
		...
		{ID: rid("index.delete"), Label: "Delete", Icon: icon("trash-2"), RouteID: rid("index.delete"), Params: indexParams(), Confirm: true, ConfirmText: "Delete this index and its documents?", Bulk: true},
		...
		{ID: rid("task.cancel"), Label: "Cancel", Icon: icon("ban"), RouteID: rid("task.cancel"), Params: taskParams(), Confirm: true, ConfirmText: "Cancel matching enqueued or processing tasks?", EnabledWhen: &plugin.Condition{AllOf: []plugin.Rule{{Field: "status", Op: plugin.OpIn, Value: []string{"enqueued", "processing"}}}}, Bulk: true},
		{ID: rid("task.delete"), Label: "Delete", Icon: icon("trash"), RouteID: rid("task.delete"), Params: taskParams(), Confirm: true, ConfirmText: "Delete this finished task from history?", EnabledWhen: &plugin.Condition{AllOf: []plugin.Rule{{Field: "status", Op: plugin.OpIn, Value: []string{"succeeded", "failed", "canceled"}}}}, Bulk: true},
