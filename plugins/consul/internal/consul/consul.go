// Package consul implements the HashiCorp Consul protocol plugin.
package consul
...
func (p *Plugin) Manifest() plugin.Manifest {
	return plugin.Manifest{
		...
		Version:     "0.1.0",
		Title:       "Consul",
		Description: "HashiCorp Consul cockpit: hierarchical KV browsing and editing, catalog services and nodes, health checks, sessions, prepared queries, service-mesh intentions, and ACL tokens, policies, and roles.",
		Icon:        plugin.Icon{Type: plugin.IconSVG, Value: consulIconSVG},
		Category:    plugin.CategoryOrchestration,
		Config:      configSchema(),
		Capabilities: []plugin.Capability{
			"kv", "catalog", "health", "sessions", "prepared-queries", "service-mesh", "acl", "watch",
		},
