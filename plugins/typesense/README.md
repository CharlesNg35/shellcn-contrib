# ShellCN Typesense plugin

External ShellCN plugin for Typesense.
...
```sh
CGO_ENABLED=0 go build -trimpath -ldflags "-s -w" -o shellcn-plugin-typesense ./cmd/shellcn-plugin-typesense
```
