	...
	return []plugin.ResourceType{
		...
		},
		{
			...
			Detail: plugin.DetailView{Header: plugin.HeaderSpec{Title: "${resource.namespace}/${resource.name}"}, DefaultTab: "editor", Tabs: []plugin.Panel{
				...
				{Key: "editor", Label: "Editor", Icon: icon("code"), Type: plugin.PanelCodeEditor, Source: &plugin.DataSource{RouteID: rid("document.read"), Params: documentParams()}, Config: plugin.CodeEditorConfig{Language: "json", SaveRouteID: rid("document.update"), SaveMethod: plugin.MethodPatch, SaveParams: documentParams(), RefreshField: "content"}},
			}},
		},
		{
...
func actions() []plugin.Action {
	return []plugin.Action{
		...
		{ID: rid("collection.delete"), Label: "Delete", Icon: icon("trash-2"), RouteID: rid("collection.delete"), Params: collectionParams(), Confirm: true, ConfirmText: "Delete this collection and all documents?", Bulk: true},
		...
		{ID: rid("synonym.delete"), Label: "Delete", Icon: icon("trash"), RouteID: rid("synonym.delete"), Params: synonymParams(), Confirm: true, ConfirmText: "Delete this synonym?", Bulk: true},
		{ID: rid("override.upsert"), Label: "Upsert curation set", Icon: icon("pin"), RouteID: rid("override.upsert")},
		{ID: rid("override.delete"), Label: "Delete", Icon: icon("trash"), RouteID: rid("override.delete"), Params: overrideParams(), Confirm: true, ConfirmText: "Delete this override?", Bulk: true},
		{ID: rid("key.create"), Label: "Create key", Icon: icon("plus"), RouteID: rid("key.create")},
		{ID: rid("key.delete"), Label: "Delete", Icon: icon("trash"), RouteID: rid("key.delete"), Params: keyParams(), Confirm: true, ConfirmText: "Delete this API key?", Bulk: true},
	}
}
