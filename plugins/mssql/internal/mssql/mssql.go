...
func actions() []plugin.Action {
	return []plugin.Action{
		...
		{ID: "mssql.database.drop", Label: "Drop database", Icon: icon("trash-2"), RouteID: "mssql.database.drop", Params: map[string]string{"database": "${resource.uid}"}, Confirm: true, ConfirmText: "Drop this database? All of its schemas and data will be permanently deleted.", Bulk: true},
		...
		{ID: "mssql.schema.drop", Label: "Drop schema", Icon: icon("trash-2"), RouteID: "mssql.schema.drop", Params: map[string]string{"database": "${resource.namespace}", "schema": "${resource.name}"}, Confirm: true, ConfirmText: "Drop this schema? It must be empty.", Bulk: true},
		...
		{ID: "mssql.column.drop", Label: "Drop column", Icon: icon("trash"), RouteID: "mssql.column.drop", Params: map[string]string{"id": "${record.id}", "name": "${record.name}"}, Confirm: true, ConfirmText: "Drop this column? Its data is permanently removed.", OnSuccess: &plugin.ActionSuccess{SelectTab: "columns"}, Bulk: true},
		...
		{ID: "mssql.constraint.drop", Label: "Drop constraint", Icon: icon("trash"), RouteID: "mssql.constraint.drop", Params: map[string]string{"id": "${record.id}", "name": "${record.name}"}, Confirm: true, ConfirmText: "Drop this constraint?", OnSuccess: &plugin.ActionSuccess{SelectTab: "constraints"}, Bulk: true},
		...
		{ID: "mssql.index.drop", Label: "Drop index", Icon: icon("trash"), RouteID: "mssql.index.drop", Params: map[string]string{"id": "${record.id}", "name": "${record.name}"}, Confirm: true, ConfirmText: "Drop this index?", OnSuccess: &plugin.ActionSuccess{SelectTab: "indexes"}, Bulk: true},
		{ID: "mssql.table.truncate", Label: "Truncate", Icon: icon("trash"), RouteID: "mssql.table.truncate", Params: tableParams(), Confirm: true, ConfirmText: "Truncate this table? Every row will be deleted.", Bulk: true},
		{ID: "mssql.table.drop", Label: "Drop", Icon: icon("trash-2"), RouteID: "mssql.table.drop", Params: tableParams(), Confirm: true, ConfirmText: "Drop this table? The table definition and data will be permanently deleted.", Bulk: true},
		{ID: "mssql.view.drop", Label: "Drop", Icon: icon("trash-2"), RouteID: "mssql.view.drop", Params: objectParams(), Confirm: true, ConfirmText: "Drop this view?", Bulk: true},
		...
		{ID: "mssql.user.drop", Label: "Drop user", Icon: icon("user-minus"), RouteID: "mssql.user.drop", Params: map[string]string{"database": "${resource.namespace}", "user": "${resource.name}"}, Confirm: true, ConfirmText: "Drop this database user?", Bulk: true},
	}
}
